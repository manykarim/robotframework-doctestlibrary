...
## Purpose
Repository quality gates: lint/format/type checks, parallel and timeout-guarded tests, keyword-signature compatibility snapshot, dependency hygiene, and CI that tests the checked-out code.
## Requirements
